...
export namespace collab {
    ...
    interface ISyncReceipt {
        ...
        /** SyncReceipt stage */
        stage?: (collab.SyncReceipt.Stage|null);

        /** SyncReceipt syncIds */
        syncIds?: (string[]|null);

        /** SyncReceipt messageIds */
        messageIds?: (collab.IRid[]|null);
     ...
     */
    class SyncReceipt implements ISyncReceipt {

        /**
         * Constructs a new SyncReceipt.
         * @param [properties] Properties to set
         */
        constructor(properties?: collab.ISyncReceipt);

        /** SyncReceipt stage. */
        public stage: collab.SyncReceipt.Stage;

        /** SyncReceipt syncIds. */
        public syncIds: string[];

        /** SyncReceipt messageIds. */
        public messageIds: collab.IRid[];
         ...
         * @param [properties] Properties to set
         * @returns SyncReceipt instance
         */
        public static create(properties?: collab.ISyncReceipt): collab.SyncReceipt;

        /**
         * Encodes the specified SyncReceipt message. Does not implicitly {@link collab.SyncReceipt.verify|verify} messages.
         * @param message SyncReceipt message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(message: collab.ISyncReceipt, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: collab.ISyncReceipt, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): collab.SyncReceipt;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): collab.SyncReceipt;
         ...
         * @returns SyncReceipt
         */
        public static fromObject(object: { [k: string]: any }): collab.SyncReceipt;

        /**
         * Creates a plain object from a SyncReceipt message. Also converts values to other types if specified.
         * @param message SyncReceipt
         * @param [options] Conversion options
         * @returns Plain object
         */
        public static toObject(message: collab.SyncReceipt, options?: $protobuf.IConversionOptions): { [k: string]: any };
    ...
    interface ICollabMessage {
        ...
        syncReceipt?: (collab.ISyncReceipt|null);
    }
    ...
    class CollabMessage implements ICollabMessage {
        ...
        /** CollabMessage syncReceipt. */
        public syncReceipt?: (collab.ISyncReceipt|null);

        /** CollabMessage data. */
        public data?: ("syncRequest"|"update"|"awarenessUpdate"|"accessChanged"|"syncReceipt");
...
export namespace notification {
    ...
    interface IWorkspaceNotification {
        ...
        storageLimitExceeded?: (notification.IStorageLimitExceeded|null);
    }
    ...
    class WorkspaceNotification implements IWorkspaceNotification {
        ...
        /** WorkspaceNotification storageLimitExceeded. */
        public storageLimitExceeded?: (notification.IStorageLimitExceeded|null);

        /** WorkspaceNotification payload. */
        public payload?: ("profileChange"|"permissionChanged"|"sectionChanged"|"shareViewsChanged"|"mentionablePersonListChanged"|"serverLimit"|"workspaceMemberProfileChanged"|"folderChanged"|"folderViewChanged"|"inboxNotification"|"commentChanged"|"storageLimitExceeded");
    ...
    /** Represents a StorageLimitExceeded. */
    class StorageLimitExceeded implements IStorageLimitExceeded {

        /**
         * Constructs a new StorageLimitExceeded.
         * @param [properties] Properties to set
         */
        constructor(properties?: notification.IStorageLimitExceeded);
         ...
         * @param [properties] Properties to set
         * @returns StorageLimitExceeded instance
         */
        public static create(properties?: notification.IStorageLimitExceeded): notification.StorageLimitExceeded;
         ...
         * @param message StorageLimitExceeded message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(message: notification.IStorageLimitExceeded, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: notification.IStorageLimitExceeded, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
         * Decodes a StorageLimitExceeded message from the specified reader or buffer.
         * @param reader Reader or buffer to decode from
         * @param [length] Message length if known beforehand
         * @returns StorageLimitExceeded
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): notification.StorageLimitExceeded;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): notification.StorageLimitExceeded;
         ...
         * @returns StorageLimitExceeded
         */
        public static fromObject(object: { [k: string]: any }): notification.StorageLimitExceeded;

        /**
         * Creates a plain object from a StorageLimitExceeded message. Also converts values to other types if specified.
         * @param message StorageLimitExceeded
         * @param [options] Conversion options
         * @returns Plain object
         */
        public static toObject(message: notification.StorageLimitExceeded, options?: $protobuf.IConversionOptions): { [k: string]: any };
