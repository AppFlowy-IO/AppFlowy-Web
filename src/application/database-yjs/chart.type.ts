...
export interface ChartLayoutSettings {
  ...
  yFieldId?: string; // Only for non-Count aggregations
}
 ...
 */
export const GROUPABLE_FIELD_TYPES = [3, 4, 5] as const; // SingleSelect, MultiSelect, Checkbox

/**
 * Check if a field type is groupable for charts
 */
