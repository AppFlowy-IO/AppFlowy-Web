...
export function AIChat({
  ...
  const requestInstance = useMemo(() => {
    ...
    request.updateViewName = async(view: View, name: string) => {
      try {
    ...
    request.insertContentToView = async(viewId: string, data: EditorData) => {
      onOpenView(viewId, data);
    };

    request.createViewWithContent = async(parentViewId: string, name: string, data: EditorData) => {
      try {
